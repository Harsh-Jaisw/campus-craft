...
function HomeCustomer() {
  ...
  return (
    ...
    <span className='text-center'>
        ...
        <h2 className="text-xl md:text-2xl font-bold">Partnered Colleges</h2>
    ...
    <span className='text-center'>
        ...
        <span className='text-2xl md:text-3xl font-[800]'>+</span>
        <h2 className="text-xl md:text-2xl font-bold">Satisfied Students</h2>
    ...
    <span className='text-center'>
        ...
        <span className='text-2xl md:text-3xl font-[800]'>+</span>
        <h2 className="text-xl md:text-2xl font-bold">Successful Placements</h2>
    ...
    <span className='text-center'>
        ...
        <span className='text-2xl md:text-3xl font-[800]'>+</span>
        <h2 className="text-xl md:text-2xl font-bold">Informed Admissions</h2>
